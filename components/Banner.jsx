...
const Banner = () => {
  return (
    <section className="pt-12 pb-20 md:pb-36 px-4 md:px-16 flex flex-col">
      <div className="container mx-auto">
        <div>
          <h1 className="text-[48px] leading-[100%] tracking-tight md:text-[120px] lg:text-[180px] xl:text-[227px]">
            Mehedi H. Jim
          </h1>
          <h4 className="bg-black mt-6 text-[28px] text-white leading-[110%] tracking-tight md:text-[60px] lg:text-[90px] xl:text-[120px] w-fit">
